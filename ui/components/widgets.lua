...
function Widgets.drawButton(text, x, y, w, h, hover)
...
function Widgets.drawLabel(text, x, y, color)
  love.graphics.setColor(color or Theme.get().text)
  love.graphics.print(text, x, y)
end

function Widgets.drawValue(label, value, x, y, w)
...
function Widgets.drawSlider(x, y, w, value, min, max)
...
function Widgets.drawIconBar(x, y, w, h, value, maxVal, fg, bg)
